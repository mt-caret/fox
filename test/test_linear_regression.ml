...
let%expect_test "linear regression" =
  ...
  [%expect
    ...
    v_2[10]: float = sub (Tensor(-0.0064666378598043162 1.9665677929469698 -0.82202018980048819 0.55321043273971726 -0.47887754772981445 -0.59419529415798567 -0.479101132934855 -0.60615974619803537 -3.888855769581165 0.72374784193750175)(dims(10))(type_ Float)) v_1;
  ...
  [%expect
    ...
    v_5[10]: float = mul (Tensor(-0.22987507367862317 4.3463761730905182 -1.6427703619487461 1.1811642145933288 -0.86466781807436588 -1.3305171979260781 -0.976724348558953 -1.2769362756602236 -8.614129411878265 1.5829382308162989)(dims(10))(type_ Float)) v_4;
    v_6[10]: float = mul (Tensor(-0.22987507367862317 4.3463761730905182 -1.6427703619487461 1.1811642145933288 -0.86466781807436588 -1.3305171979260781 -0.976724348558953 -1.2769362756602236 -8.614129411878265 1.5829382308162989)(dims(10))(type_ Float)) v_4;
