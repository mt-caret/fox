...
let%expect_test "linear regression" =
  ...
  [%expect
    ...
    v_3[1] = reshape v_2 dims=[1];
    v_4[10] = broadcast v_3 dims=[10];
    v_5[10] = mul (Tensor(-0.22987507367862317 4.3463761730905182 -1.6427703619487461 1.1811642145933288 -0.86466781807436588 -1.3305171979260781 -0.976724348558953 -1.2769362756602236 -8.614129411878265 1.5829382308162989)(dims(10))) v_4;
    v_6[10] = mul (Tensor(-0.22987507367862317 4.3463761730905182 -1.6427703619487461 1.1811642145933288 -0.86466781807436588 -1.3305171979260781 -0.976724348558953 -1.2769362756602236 -8.614129411878265 1.5829382308162989)(dims(10))) v_4;
    v_7[10] = add v_5 v_6;
    v_8[10] = neg v_7;
    v_9[2,10] = transpose (Tensor((0.39995642633665462 1.1602368073797789)(1.1461698444484156 -0.27508260258159217)(-0.79429206930935448 -0.79691620100672833)(0.37183586790086887 0.08252530331332697)(-0.640823054843121 -0.972395618004264)(-0.24531465496199806 0.32943595058180369)(-0.49745709501288782 -0.5186552221834726)(-0.49202679675483579 -0.30011198307839476)(-2.2219543337312779 0.66654181134893775)(0.458720357930648 0.0010728286252209105))(dims(10 2)));
    v_10[2] = matmul v_9 v_8;
    ( v_10 )
    |}];
