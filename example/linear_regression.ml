...
let%expect_test "linear regression" =
  ...
  [%expect
    {|
    v_0[] ->
    v_1[] = div v_0 (Tensor 10993.328292101785)
  ...
  [%expect
    {|
    ((i 0) (loss 10.481879475248638))
    ((i 10) (loss 10.451553463002384))
    ((i 20) (loss 10.421141684835984))
    ((i 30) (loss 10.390643405712302))
    ((i 40) (loss 10.360057880020719))
    ((i 50) (loss 10.329384351362815))
    ((i 60) (loss 10.298622052332444))
    ((i 70) (loss 10.267770204289992))
    ((i 80) (loss 10.236828017130664))
    ((i 90) (loss 10.205794689046561))
    ((i 100) (loss 10.174669406282408))
    |}]
;;
